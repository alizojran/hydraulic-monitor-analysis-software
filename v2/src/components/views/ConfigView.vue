    ...
    <div class="config-body">
        ...
        <table class="cfg-table">
          ...
          <tbody>
            <tr v-for="ch in CHANNEL_DEFS" :key="ch.id">
              ...
              <td>
                <input
                  v-model="configStore.channels[ch.id].name"
                  type="text"
                  style="width: 140px"
                />
              </td>
              ...
              <td>
                <select
                  ...
                  @change="
                    configStore.updateChannel(ch.id, {
                      coupling: ($event.target as HTMLSelectElement).value as any,
                    })
                  "
                >
                  <option>DC</option>
        ...
        <div class="acq-grid">
          ...
          <div class="acq-item">
            ...
            <select
              ...
              @change="
                configStore.updateAcq({
                  triggerType: ($event.target as HTMLSelectElement).value as any,
                })
              "
            >
      ...
      <div v-show="activeTab === 'about'" class="tab-pane">
        ...
        <div class="about-grid">
          <div class="about-row">
            <span class="about-key">{{ $t('config.about.version') }}</span
            ><span class="about-val mono">v2.0.0</span>
          </div>
          <div class="about-row">
            <span class="about-key">{{ $t('config.about.build') }}</span
            ><span class="about-val mono">2026-05-10</span>
          </div>
          <div class="about-row">
            <span class="about-key">Runtime</span
            ><span class="about-val mono">Vue 3 + Pinia + Vite</span>
          </div>
          <div class="about-row">
            <span class="about-key">Rendering</span
            ><span class="about-val mono">WebGL2 + Canvas2D</span>
          </div>
          <div class="about-row">
            <span class="about-key">Signal</span
            ><span class="about-val mono">FFT · Octave · Bearing · Gear · Envelope</span>
          </div>
        </div>
      </div>
    </div>
