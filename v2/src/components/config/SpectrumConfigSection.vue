  ...
  <div class="cfg-section">
    ...
    <div class="cfg-grid">
      <div class="cfg-row">
        ...
        <select :value="dsp.fftConfig.fftSize" @change="dsp.setFftConfig({ fftSize: parseInt(($event.target as HTMLSelectElement).value) as any })">
      ...
      <div class="cfg-row">
        ...
        <select :value="dsp.fftConfig.window" @change="dsp.setFftConfig({ window: ($event.target as HTMLSelectElement).value as any })">
      ...
      <div class="cfg-row">
        ...
        <select :value="dsp.fftConfig.averages" @change="dsp.setFftConfig({ averages: parseInt(($event.target as HTMLSelectElement).value) as 1|4|8|16|32 })">
      ...
      <div class="cfg-row">
        ...
        <select :value="dsp.fftConfig.overlap" @change="dsp.setFftConfig({ overlap: parseFloat(($event.target as HTMLSelectElement).value) as any })">
      ...
      <div class="cfg-row">
        ...
        <div class="toggle-group">
          <button :class="{ active: dsp.xAxisMode === 'hz' }" @click="dsp.xAxisMode !== 'hz' && dsp.toggleXAxisMode()">Hz</button>
          <button :class="{ active: dsp.xAxisMode === 'order' }" @click="dsp.xAxisMode !== 'order' && dsp.toggleXAxisMode()">Order</button>
        </div>
      </div>
      ...
      <div class="cfg-row">
        ...
        <div class="toggle-group">
          <button :class="{ active: dsp.envelopeMode }" @click="!dsp.envelopeMode && dsp.toggleEnvelopeMode()">ON</button>
          <button :class="{ active: !dsp.envelopeMode }" @click="dsp.envelopeMode && dsp.toggleEnvelopeMode()">OFF</button>
        </div>
      </div>
      ...
      <div class="cfg-row">
        ...
        <div class="toggle-group">
          <button :class="{ active: dsp.octaveWeighting === 'A' }" @click="dsp.setOctaveWeighting('A')">A</button>
          <button :class="{ active: dsp.octaveWeighting === 'C' }" @click="dsp.setOctaveWeighting('C')">C</button>
          <button :class="{ active: dsp.octaveWeighting === 'none' }" @click="dsp.setOctaveWeighting('none')">{{ $t('spectrum.noWeighting') }}</button>
        </div>
      </div>
    </div>
  </div>
